...
public class LZ4DecompressionFilter extends AbstractConfig {
    ...
    protected void construct() {
        ...
        engine.addFilter(
                new flens.filter.LZ4DecompressionFilter(name, plugin, tagger, matcher, prio, inf, outf, discard));
    ...
    public String getDescription() {
        return "use lz4 to decompress records";
    }
