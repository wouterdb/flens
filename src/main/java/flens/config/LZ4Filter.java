...
public class LZ4Filter extends AbstractConfig{
	...
	protected void construct() {
		...
		engine.addFilter(new flens.filter.LZ4Filter(name,plugin,tagger,matcher,prio,inf,outf,discard));
